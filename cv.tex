...
\begin{itemize}
  \item Visiting Student, Computer Science, The Johns Hopkins University, 2016
    ...
    \item \emph{Research interests:}
      \begin{itemize}
      \item Vision-based soft tissue manipulation using DVRK and cisst/SAW environment
      \end{itemize}
    \end{itemize}
  \item Ph.D. Candidate, Mechanical \& Automation Engineering, The Chinese Univ. of Hong Kong, since 2013
    \begin{itemize}
    \item \emph{Cumulative GPA:} 3.94/4
    \item \emph{Research interests:}
      \begin{itemize}
...
\item \textbf{Z. Wang}, H.M. Yip, D. Navarro-Alarcon, P. Li, Y.-H. Liu, D. Sun, H. Wang and T.H. Cheung,
  ...
  \textit{{IEEE/ASME} Trans. Mechatronics}, vol21, no. 2, pp. 1193-1198, Apr. 2016.
...
\item D. Navarro-Alarcon, H.M. Yip, \textbf{Z. Wang}, Y.-H. Liu, F. Zhong, T. Zhang and P. Li,
  ...
  \textit{{IEEE} Trans. Robot.}, vol. 32, no. 2, pp. 429-441, March 2016.
\end{enumerate}
